...
class CrossEncoderReranker:
      ...
      async def rerank(self, query: str, candidates: List[Tuple[int, float, str]]) -> List[Tuple[int, float]]:
            ...
            reranked = []
            for (chunk_id, orig_score, _), rerank_score in zip(candidates, scores):
                  final_score = 0.6 * orig_score + 0.4 * float(rerank_score)
